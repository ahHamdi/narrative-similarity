...
df_fr = pd.read_csv("plots_fr_en.autotrain.csv").dropna(
    subset=["plots_en", "plots_fr_en"]
)
df_pt = pd.read_csv("plots_pt_en.autotrain.csv").dropna(
    subset=["plots_en", "plots_pt_en"]
)
df_es = pd.read_csv("plots_es_en.autotrain.csv").dropna(
    subset=["plots_en", "plots_es_en"]
)

common_plots = set(df_fr["plots_en"]) & set(df_pt["plots_en"]) & set(df_es["plots_en"])
